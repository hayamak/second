// src/app/(app)/organisation/_components/organisation-search-form.tsx
...
import { organisationSearchSchema } from "@/schemas/organisation"

export default function OrganisationSearchForm() {
  ...
  const handleSubmit = async (event: SyntheticEvent<HTMLFormElement>) => {
    ...
    const result = organisationSearchSchema.safeParse({
